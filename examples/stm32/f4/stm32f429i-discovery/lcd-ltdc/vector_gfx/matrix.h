...
//	mat.a *= vector_flt_cos(angle);
//	mat.b  = vector_flt_sin(angle);
//	mat.p  = -mat.b;
//	mat.q  = mat.a;
//	return mat;
}
...
mat3x3_mult(mat3x3_t A, mat3x3_t B) {
	return (mat3x3_t) {
		.a=A.a*B.a+A.b*B.p+A.c*B.u, .b=A.a*B.b+A.b*B.q+A.c*B.v, .c=A.a*B.c+A.b*B.r+A.c*B.w,
		.p=A.p*B.a+A.q*B.p+A.r*B.u, .q=A.p*B.b+A.q*B.q+A.r*B.v, .r=A.p*B.c+A.q*B.r+A.r*B.w,
		.u=A.u*B.a+A.v*B.p+A.w*B.u, .v=A.u*B.b+A.v*B.q+A.w*B.v, .w=A.u*B.c+A.v*B.r+A.w*B.w
	};
}

static inline
void
mat3x3_affine_transform(mat3x3_t mat, point2d_t *points_dest, point2d_t *points_src, size_t points_count) {
	while (points_count--) {
		point2d_t p = *points_src++; // this allows for src and dest to be the same array
